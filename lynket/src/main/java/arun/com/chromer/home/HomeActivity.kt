...
class HomeActivity : BaseActivity(), Snackable, UsesViewModel {
  ...
  private fun handleDeepLinkIfAny() {
    ...
    FirebaseDynamicLinks.getInstance()
      ...
      .addOnSuccessListener(this) { pendingDynamicLinkData ->
        ...
        if (pendingDynamicLinkData != null) {
          ...
          val url = deepLink?.toString()?.substring(24)
          tabsManger.openUrl(this@HomeActivity, Website(url.toString()))
        }
      }.addOnFailureListener(this) { e : Exception ->
        Log.w("HOME", "getDynamicLink:onFailure", e)
      }
