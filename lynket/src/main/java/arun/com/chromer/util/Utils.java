    ...
    if (url != null) {
      ...
      try{
        ...
        DynamicLink dynamicLink = FirebaseDynamicLinks.getInstance().createDynamicLink()
          .setLink(Uri.parse("https://www.utkarsh.com/" + url))
          .setDomainUriPrefix("https://lynketbrowser.page.link")
          .setAndroidParameters(new DynamicLink.AndroidParameters.Builder().setFallbackUrl(Uri.parse("https://play.google.com/store/apps/details?id=arun.com.chromer")).build())
        ...
        Intent chooserIntent = Intent.createChooser(shareIntent, "Share URL via");
